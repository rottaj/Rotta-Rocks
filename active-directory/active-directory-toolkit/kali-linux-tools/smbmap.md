---
description: >-
  SMBMap is great for enumerating shares from a Linux attack host. It can be
  used to gather a listing of shares, permissions, and share contents.
---
...
```shell-session
attcker@kali$ smbmap -u forend -p Klmcargo2 -d INLANEFREIGHT.LOCAL -H 172.16.5.5
...
```shell-session
attacker@kali$ smbmap -u forend -p Klmcargo2 -d INLANEFREIGHT.LOCAL -H 172.16.5.5 -R 'Department Shares' --dir-only
